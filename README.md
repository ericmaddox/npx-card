# Eric Maddox - npx Business Card

An AI Alchemist's digital business card, executable via npx.
...
![npx ericmaddox](https://github.com/ericmaddox/npx-card/blob/main/assets/npx_cardv4.png?raw=true)
